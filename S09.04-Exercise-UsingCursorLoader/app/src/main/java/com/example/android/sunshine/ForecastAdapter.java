...
//      TODO (7) Generate a weather summary with the date, description, high and low
        ...
        Integer weatherId = mCursor.getInt(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID));
        ...
        String summary = MessageFormat.format("date {0}, description: {1}, high {2}, low {3}", date, weatherId, highTemp, minTemp);
