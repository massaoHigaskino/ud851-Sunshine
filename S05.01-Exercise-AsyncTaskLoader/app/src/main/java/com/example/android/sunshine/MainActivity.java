...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int SUNSHINE_LOADER_ID = 1;
    ...
    private void loadWeatherData() {
        ...
        Loader loader = loaderManager.getLoader(SUNSHINE_LOADER_ID);
        if(loader == null) {
            loaderManager.initLoader(SUNSHINE_LOADER_ID, bundle, this);
        } else {
            loaderManager.restartLoader(SUNSHINE_LOADER_ID, bundle, this);
        }
    }
