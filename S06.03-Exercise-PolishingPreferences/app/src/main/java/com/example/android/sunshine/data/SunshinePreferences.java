...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return preferences.getString(context.getString(R.string.pref_location_key), getDefaultWeatherLocation());
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String value = preferences.getString(context.getString(R.string.pref_units_key), metricValue);
        return metricValue.equals(value);
    }
