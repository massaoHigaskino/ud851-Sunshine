...
//  TODO (6) Declare constant IDs for the ViewType for today and for a future day
    public static final int VIEW_TYPE_TODAY = R.layout.forecast_list_item_today;
    public static final int VIEW_TYPE_FUTURE_DAY = R.layout.forecast_list_item;
...
//      TODO (8) Set mUseTodayLayout to the value specified in resources
        ...
        mUseTodayLayout = sp.getBoolean(context.getString(R.string.pref_enable_today_layout_key), context.getResources().getBoolean(R.bool.use_today_layout));
    }
...
//      TODO (14) Otherwise, throw an IllegalArgumentException
            default:
                throw new IllegalArgumentException("Invalid layout type for this RecyclerView.");
        }
